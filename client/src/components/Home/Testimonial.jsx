    ...
    return (
        <>
            <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12">
                ...
                <Tittle tittle="Don't just take our words" description="hear what our users say  about us. We're always looking for ways to imporve. if you have a positive experience with us, leave a review."/>
            </div>
            <style>{`
