                    ...
                    {data.map((project,index) => {
                        ...
                        <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea rows={4} value={project.description || ""} onChange={(e) => updateProject(index,"description",e.target.value)} className="w-full text-sm px-3 py-2 rounde-lg resize-none" placeholder="Describe key features and challenges..."/>
                            </div>
                        </div>
                    )})}
                </div>
