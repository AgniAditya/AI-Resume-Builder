            ...
            <div className="flex items-center gap-2">
                <label>
                    {data.image ? (
                        ...
                        <div className="inline-flex items-center gap-2 mt-5 text-slate-600 hover:text-slate-700 cursour-pointer">
