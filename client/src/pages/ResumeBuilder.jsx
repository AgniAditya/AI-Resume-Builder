...
const ResumeBuilder = () => {
    ...
    const activeSections = section[activeSectionIndex]
                    ...
                    <div className="lg:col-span-7 max-lg:mt-6">
                        <div className="relative w-full">
                            ...
                            <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                                ...
                                <button onClick={downloadResume} className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 ring-purple-300 rounded-lg hover:ring transition-colors">
